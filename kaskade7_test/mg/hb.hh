...
namespace Kaskade {
  ...
  * or even faster in 3D. If the simplicity of the PrecondType::HB preconditioner does'nt pay off, have a look at 
  * \ref MultigridSolver or \ref BPXYPreconditioner.
  *
