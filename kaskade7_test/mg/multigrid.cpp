...
/*                                                                           */
/*  Copyright (C) 2015-2022 Zuse Institute Berlin                            */
/*                                                                           */
...
void checkP1(int refinements, int steps)
{
  ...
  GridManager<Grid> gridManager( createUnitSquare<Grid>(1) );
...
void checkPp(int refinements, int steps, int order)
{
  ...
  GridManager<Grid> gridManager( createUnitSquare<Grid>(1.00000) );
