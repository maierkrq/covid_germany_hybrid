...
namespace Kaskade
{
   ...
   *
   * \tparam Eq a parabolic equation, a model of the ParabolicEquation interface.
   */
  template <class Eq>
  class Limex
  {
  ...
  public:
    ...
    /**
     * \brief Computes a state increment that advances the given state in
