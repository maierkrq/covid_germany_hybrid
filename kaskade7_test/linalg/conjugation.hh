...
namespace Kaskade
{
   ...
   *                           and only create the lower triangle of the resulting matrix P^T A P
   * \param createDiagonal. If true, the diagonal of the result will be structurally nonzero, even if not resulting from the 
   *                        sparsity patterns of P and A.
   * \return the sparse matrix \f$ P^T A P \f$
   */
