...
namespace Kaskade
{
  ...
  /**
   * \ingroup linalgsolution
   * \brief Relative energy error termination criterion according to Strakos, Tichy: Error estimation in preconditioned conjugate gradients.
  ...
  /** 
   * \ingroup linalgsolution
   * \brief Relative error termination criterion based on the norm induced by the preconditioner,
