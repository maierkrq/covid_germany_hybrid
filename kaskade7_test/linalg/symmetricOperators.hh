...
namespace Kaskade
{
  ...
  public:
    virtual field_type operator()(X const& x, Xstar const& y) const { return x*y; }
  };
  ...
  /**
   * \ingroup linalgbasic
   * \brief A symmetric operator represented by a matrix.
   */
  template <class X, class Matrix>
  class SymmetricMatrixOperator: public SymmetricLinearOperator<X,X>
  {
  public:
    typedef typename X::field_type field_type;
  ...
  /**
   * \ingroup linalgbasic
   * \brief The trivial (identity) preconditioner.
   */
  template <class X>
  class IdentityPreconditioner: public SymmetricPreconditioner<X,X> 
  {
  public:
    typedef typename X::field_type field_type;
