...
namespace Kaskade
{
  namespace SchurPreconditionerDetail
  {
    ...
    {
      typedef typename Operator::Assembler::AnsatzVariableSetDescription::template CoefficientVectorRepresentation<Block::firstCol,Block::lastCol>::type Domain;
      typedef typename Operator::Assembler::TestVariableSetDescription::template   CoefficientVectorRepresentation<Block::firstRow,Block::lastRow>::type Range;
    };
