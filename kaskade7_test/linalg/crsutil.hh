...
namespace Kaskade
{
  ...
  namespace Crsutil_Detail
  {
    ...
    struct VectorTraits
    {
      static const bool contiguous = std::is_arithmetic_v<Vec>;
    };

    template <class Entry>
    struct VectorTraits<Dune::BlockVector<Entry>>
    {
      static const bool contiguous = VectorTraits<Entry>::contiguous;
    };

    template <class Entry, int n>
    struct VectorTraits<Dune::FieldVector<Entry,n>>
    {
      static const bool contiguous = VectorTraits<Entry>::contiguous;
    };
  }
