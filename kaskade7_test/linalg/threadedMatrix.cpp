...
namespace Kaskade
{
  namespace ThreadedMatrixDetail
  {
    ...
    template size_t CRSChunkPatternCreator<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::balanceForward(size_t const covered, size_t const nnz, int chunks,
                                                                std::vector<CRSChunkPatternCreator<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::IndexArray>& moveRows);
    ...
    template size_t CRSChunkPatternCreator<int>::balanceBackward(size_t const covered, size_t const nnz, int chunks, 
                                                                 std::vector<CRSChunkPatternCreator<int>::IndexArray>& moveRows);
    template size_t CRSChunkPatternCreator<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::balanceBackward(size_t const covered, size_t const nnz, int chunks,
                                                                 std::vector<CRSChunkPatternCreator<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::IndexArray>& moveRows);
    ...
    template size_t CRSChunkPattern<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::nonzeroes() const;
    ...
    template CRSChunkPattern<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::CRSChunkPattern(CRSChunkPatternCreator<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>> const& creator);
  }
  ...
  template void NumaCRSPatternCreator<std::conditional_t<std::is_same<size_t, unsigned int>::value, short, unsigned int>>::balance();
