...
namespace Kaskade
{
  ...
  public:
    ...
    void solve(std::vector<double>& sol, SparseLinearSystem& lin)
    {
      ...
      //   mat.print();
      factorization.reset(new UMFFactorization<Scalar,int>(mat.nrows(), mat.ridx, mat.cidx, mat.data)/*factory.create(solverName, mat.nrows(), mat.ridx, mat.cidx, mat.data) */);
