...
namespace Kaskade 
{
  ...
  public:
     ...
     * \param align The alignment of the memory to return. Has to be a power of 2, and significantly below blocksize. 
     *              Defaults to common cache line size of 64 bytes. 
     * \param blocksize The size of memory blocks to be requested from libnuma. Has to be a multiple of \f$ 4096 \f$. 
     *                  Defaults to 2^21, which is two MB.
 ...
 true
  ...
  private:
    ...
    mutable std::mutex mutex;   // mutex for protection against concurrent access
