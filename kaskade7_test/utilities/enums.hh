...
/**
 * \brief Whether to execute some algorithm in sequential or parallel manner.
 */
enum class ParallelMode {
  /// perform all operations in sequential order
  SEQUENTIAL,
  // group operations in blocks, perform sequential within blocks, do blocks in parallel
  BLOCKPARALLEL,
  // perform all operations in parallel (at least conceptually), independent of each other
  PARALLEL };
