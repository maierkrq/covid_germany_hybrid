...
/*                                                                           */
/*  Copyright (C) 2009-2018 Zuse Institute Berlin                            */
/*                                                                           */
...
namespace Kaskade
{
  ...
  struct IoOptions
  {
    ...
    enum DataMode
    {
      ...
      nonconforming, 
      /**
       * Tells the file writer to choose the most appropriate version automatically based on the
     ...
     * and 2 (quadratic continuous or discontinuous). Other orders are not supported (and will be silently clamped to {0,1,2}).
     */
    ...
    /**
     * \brief Sets the number of decimal digits to be written for floating point numbers.
     */
