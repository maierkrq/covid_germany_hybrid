...
#ifndef READPOLYHIPJOINT_HH
#define READPOLYHIPJOINT_HH
 ...
 * \param scalingFactor: Scale the geometries to the right size (from numerical units to meter)
 */
std::unique_ptr<Dune::UGGrid<2> > readPolyData(std::string const& name, int heapSize=500, int mortarCheck = 0,
                                               Dune::BitSetVector<1>* implantElement=nullptr, std::array<double,3>* pelvis=nullptr, double scalingFactor=1);
