...
namespace Kaskade
{
   ...
   *
   * \tparam Scalar the field type to be used
   * \tparam dim the spatial dimension
   * \tparam components the vectorial dimension of shape functions
   */
  ...
  struct VariationalArg
  {
    ...
    /**
     * \brief type of variational argument's value 
     */
    ...
    /**
     * \brief The shape function's value, a vector of dimension `components`
     */
    ValueType value;

    /**
     * \brief The shape function's spatial derivative, a `components` x `dim` matrix.
     */
