...
namespace Kaskade
{
  ...
  /**
   * \brief Computes the d-c+1 local vertex indices of the vertices incident to the
   * k-th subentity of codimension c in the reference simplex of
   * dimension d.
   * 
   * \param d spatial dimension of the reference simplex
   * \param c codimension of the considered subentity
   * \param k number of the subentity (among all of given codimension c)
   * \param idx output iterator, where d-c+1 values are stored
   */
