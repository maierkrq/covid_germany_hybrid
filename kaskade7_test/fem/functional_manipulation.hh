...
namespace Kaskade
{
// APPEARS TO BE UNUSED (and is anyways undocumented and in a bad state).  
// WILL BE REMOVED AFTER 2019-08.
...
//   };
  ...
  // DEPRECATED. TODO: improve functional difference in functional_aux.hh to cover arbitrary linear combinations
  // SumFunctional appears to be essentially unused (only found an occurence in
  // KaskadeProblems/stateConstraints/stateConstraints_aux.hh from 2009).
