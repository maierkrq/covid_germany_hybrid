...
namespace Kaskade
{
  ...
  class [[deprecated]]
  BoundaryMapper : public UniformScalarMapper<typename BoundarySpace_Detail::ChooseMapper<Implementation_<Scalar_,GridView_>>::type,
  ...
  namespace ScalarSpaceDetail
  {
    ...
    public:
       ...
       */
      std::pair<bool,size_t> unrestrictedToRestrictedIndex(std::vector<std::pair<bool,size_t>>::size_type unrestrictedIndex) const {
