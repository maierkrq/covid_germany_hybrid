...
namespace Kaskade
{
  ...
  {
    using namespace boost::fusion;
    auto const& gridView = at_c<0>(spaces)->gridView();
    auto const& cellRanges = at_c<0>(spaces)->gridManager().cellRanges(gridView); 
   ...
   * \ref IdentityScaling is provided.
   */
