...
namespace Kaskade
{
  /** 
   * \ingroup fem
   * \brief A finite element space of globally constant functions on the leaf grid view.
   */
  ...
  /**
   * \ingroup fem
   * \brief An \f$ L^2 \f$ conforming finite element space on the leaf grid view with Lagrange basis.
   */
  template <class Grid, class Scalar=double>
