...
namespace Kaskade {
  ...
  protected:
    /**
     * \brief Accepts an (approximate) resting state.
     * \param uFix approximate resting state of the transmembrane voltage
     * \param vFix approximate resting state of the gating variables
     * 
     * The method shall be used by derived classes to provide an approximate value of the resting state
     * (which needs to be a stable fixed point). A few iterations of Newton's method are performed in order
  ...
  /**
   * \ingroup membranemodels
   * \brief Physiologcial model by tenTusscher et al. (2006)
   * 
