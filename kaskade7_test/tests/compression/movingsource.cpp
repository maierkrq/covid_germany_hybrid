...
//       writeVTKFile(gridManager.grid().leafGridView(), variableSet, state_data, fn.str());
...
//       LeafGridView leafGridView = gridManager.grid().leafGridView();
//       std::ostringstream fn ; 
//       fn.width(3);  fn.fill('0');
//       fn.setf(std::ios_base::right,std::ios_base::adjustfield);
//       fn << "graph/pred" ;
//       fn << i+2 ;
//       fn.flush();
//       writeVTKFile(leafGridView,variableSet,pred,fn.str() );
//       
