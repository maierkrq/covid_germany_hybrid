...
class MovingSourceEquation
{
  typedef MovingSourceEquation<RType,VarSet> Self;
public:
...
//       printf("DomainCache::evaluateAt x=(%e,%e), xglob=(%e,%e), t=%e\n",
//               x[0], x[1], xglob[0], xglob[1], t);
...
/// show the usage of MovingSourceEquation
///
#endif
